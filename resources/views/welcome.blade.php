...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=fi600&display=swap" rel="stylesheet" />

    <!-- Styles -->
    <style>
        /* ! tailwindcss v3.4.1 | MIT License | https://taigtree:400,lwindcss.com */
        *,
        ::after,
        ::before {
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <h1 class="text-center  font-bold text-4xl">COlor</h1>
